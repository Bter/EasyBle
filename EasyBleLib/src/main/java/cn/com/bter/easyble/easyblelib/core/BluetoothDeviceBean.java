...
public class BluetoothDeviceBean extends BluetoothDeviceBase {
    ...
    private Runnable connectTimeOut = new Runnable() {
        ...
        public void run() {
            ...
            poastConnectState(BluetoothDeviceBean.this, connectStatus);
        }
    };
     ...
     * @param currentState
     */
    private void poastConnectState(BluetoothDeviceBean device, int currentState){
     ...
     * data call back {@link IOnReadRemoteRssiCallBack#onReadRemoteRssi(BluetoothDeviceBean, int)}
     */
            ...
            if(null != gatt){
                ...
                if(null != getBleDevice() && getBleDevice().equals(device)) {
                    ...
                    if(newState == BluetoothProfile.STATE_DISCONNECTED
                        ...
                        poastConnectState(BluetoothDeviceBean.this, STATE_CONNECT_FAILD);
                    }else{
                        poastConnectState(BluetoothDeviceBean.this, newState);
                    }
